                                ...
                                <table style="margin-left:170px">
                                    <tr>
                                        <th>
                                            ...
                                            <CButton @click="submit3moi()">
                                                <i class="fa fa-globe" aria-hidden="true"
                                                    style="font-size:55px;margin-left: -220px; color:white;margin-top: 40px;"></i>
                                        ...
                                        <th>
                                            <CButton @click="submit6moi()">
                                                ...
                                                <i class="fa fa-briefcase"
                                                    style="font-size:55px;margin-left: -50px; color:white;margin-top: 40px;"></i>
                                            </CButton>
                                            <stripe-checkout ref="checkoutRef" mode="payment" :pk="publishableKey"
                                                :line-items="lineItems" :success-url="successURL"
                                                :cancel-url="cancelURL" @loading="v => loading = v" />
                                        </th>
                                        <th>
                                    ...
                                    <tr>
                                        <th>
                                            ...
                                            <p
                                                style="font-size:20px;margin-left: -140px; color:white;margin-top: 40px;">
                                                3 mois </p>
                                            <p
                                                style="font-size:20px;margin-left: -130px; color:white;margin-top: 25px;">
                                                60dt </p>
                                        ...
                                        <th>
                                            <CButton>
                                                ...
                                                <p
                                                    style="font-size:20px;margin-left: -50px; color:white;margin-top: 40px;">
                                                    6 mois</p>
                                                <p
                                                    style="font-size:20px;margin-left: -50px; color:white;margin-top: 25px;">
                                                    100dt </p>
                                            </CButton>
                                            <stripe-checkout ref="checkoutRef" mode="payment" :pk="publishableKey"
                                                :line-items="lineItems" :success-url="successURL"
                                        ...
                                        <th>
                                            <p style="font-size:20px;margin-left: 50px; color:white;margin-top: 40px;">
                                                9 mois</p>
                                            <p style="font-size:20px;margin-left: 50px; color:white;margin-top: 25px;">
                                                130dt </p>
                                        </th>
                                        <th>
                                            <p style="font-size:20px;margin-left: 70px; color:white;margin-top: 40px;">
                                                1 an</p>
                                            <p style="font-size:20px;margin-left: 60px; color:white;margin-top: 25px;">
                                                170dt </p>
                                        </th>
                                    </tr>
                                </table>
...
export default ({
    ...
    data() {
        ...
        return {
            ...
            lineItems: [
                {
                    price: 'price_1LCr73G4QVPUaXoLf52Nzrgn', // The id of the one-time price you created in your Stripe dashboard
                    quantity: 1,
                },
            ],
            successURL: 'http://localhost:8080/#/pages/success',
    ...
    methods: {
        ...
        submit3moi() {
            ...
            localStorage.setItem("recruteur", JSON.stringify(recruteur))
            this.typedate = 90
            let key = "price_1LCr73G4QVPUaXoLf52Nzrgn"
        ...
        submit6moi() {
            ...
            localStorage.setItem("recruteur", JSON.stringify(recruteur))
            this.typedate = 180
            let key = "price_1LCr8mG4QVPUaXoLlsdbQeY4"
        ...
        submit9moi() {
            ...
            localStorage.setItem("recruteur", JSON.stringify(recruteur))
            this.typedate = 270
            let key = "price_1LCr9ZG4QVPUaXoLZwdzMCkP"
            localStorage.setItem("key", key)
            localStorage.setItem("typedate", this.typedate)
            this.$refs.checkoutRef.redirectToCheckout();
        },
        submit1an() {
            ...
            localStorage.setItem("recruteur", JSON.stringify(recruteur))
            this.typedate = 365
            let key = "price_1LCrA1G4QVPUaXoLjOhy1RQ6"
            localStorage.setItem("key", key)
            localStorage.setItem("typedate", this.typedate)
            this.$refs.checkoutRef.redirectToCheckout();
        },
