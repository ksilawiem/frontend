                                    ...
                                    <CCol :md="8">
                                        <CCardBody>
                                            <CCardTitle>
                                                ...
                                                <h6 class="u">offre: {{offre.name}}</h6>
                                                <br>
                                                <h6 class="u">score: {{post.score}}</h6>
                                            </CCardTitle>
                                            <Button class="btn5" @click="$router.push('/dashboard')">
                                                Terminer</Button>
                                        </CCardBody>
                                    </CCol>
                                </CRow>
...
export default {
    ...
    mounted() {
    axios.get("http://localhost:8000/api/postuler/"+this.postID).then((res) => {
