...
<template >
  ...
  <h6 class="m"><i>Mes recruteurs</i></h6>
  ...
  <CTable class="table">
    <CTableHead>
      <CTableRow>
        ...
        <CTableHeaderCell type="file" scope="col" class="etat" @click="tri('company')">Entreprise
          <i class="fa fa-long-arrow-up" v-if="sortedby == 'company'"></i>
          <i class="fa fa-long-arrow-down" v-if="sortedby == 'companydesc'"></i>
        </CTableHeaderCell>
        <CTableHeaderCell scope="col" class="etat" @click="tri('modePaiment')">mode de paiement
          <i class="fa fa-long-arrow-up" v-if="sortedby == 'modePaiment'"></i>
          <i class="fa fa-long-arrow-down" v-if="sortedby == 'modePaimentdesc'"></i>
        </CTableHeaderCell>
        <CTableHeaderCell scope="col" class="etat" @click="tri('début')">date début
          <i class="fa fa-long-arrow-up" v-if="sortedby == 'début'"></i>
          <i class="fa fa-long-arrow-down" v-if="sortedby == 'débutdesc'"></i>
        </CTableHeaderCell>

        <CTableHeaderCell scope="col" class="etat" @click="tri('gender')">date fin
      ...
      <CTableRow>
        ...
        <CTableHeaderCell scope="col" class="etat">
          <input class="input2" type="text" v-model="filterparcomp">
    ...
    <CTableBody>
      <CTableRow v-for="user in filtredUser" :key="user.id">
        ...
        <CTableDataCell class="etat">{{ user.company }}</CTableDataCell>
        <CTableDataCell class="etat">{{ user.modePaiment }}</CTableDataCell>
        <CTableDataCell class="etat">{{ user.début }}</CTableDataCell>
        <CTableDataCell class="etat">{{ user.fin }}</CTableDataCell>

        <CTableDataCell>

          <CButton class="btn"><i class="fa fa-envelope"></i></CButton>
